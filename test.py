...
datapath = 'dataset'
model_Path = './acoustic_model/cnn3ctc20190705_1425/e_95.model'
model_session = Acoustic_model(datapath)
model_session.Load_Model(filename = model_Path)
model_session.Test_model_all(modelpath = model_Path, datapath = './dataset', str_Data = 'train', data_Count = 6500 )
